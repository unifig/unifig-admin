<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>广告列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="padding: 6px 7px !important;">添加广告</el-button>
    </el-card>
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="id" width="120" align="center">
          <template slot-scope="scope">{{scope.row.skipValue}}</template>
        </el-table-column>
        ...
        <el-table-column label="点击次数" width="80" align="center">
