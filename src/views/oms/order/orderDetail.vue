  ...
  <div class="content-section" style="margin-top: 70px;border-bottom: 0;">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        ...
        <div class="operate-button-container" v-show="order.status===0">
          <el-button type="primary" size="mini" @click="showUpdateReceiverDialog">修改收货人信息</el-button>
          <el-button type="primary" size="mini">修改商品信息</el-button>
          <el-button type="primary" size="mini" @click="showUpdateMoneyDialog">修改费用信息</el-button>
          <el-button type="primary" size="mini" @click="showMessageDialog">发送站内信</el-button>
          <el-button size="mini" @click="showCloseOrderDialog">关闭订单</el-button>
          <el-button type="primary" size="mini" @click="showMarkOrderDialog">备注订单</el-button>
        </div>
        ...
        <div class="operate-button-container" v-show="order.status===2||order.status===3">
          <el-button type="primary" size="mini" @click="showLogisticsDialog">订单跟踪</el-button>
          <el-button type="primary" size="mini" @click="showMessageDialog">发送站内信</el-button>
          <el-button type="primary" size="mini" @click="showMarkOrderDialog">备注订单</el-button>
        </div>
    ...
    <el-dialog title="修改收货人信息"
      ...
      <el-form :model="receiverInfo"
        ...
        <el-form-item class="nr" label="详细地址：">
    ...
    <el-dialog title="发送站内信"
      ...
      <el-form :model="message"
        ...
        <el-form-item class="nr" label="内容：">
    ...
    <el-dialog title="关闭订单"
      ...
      <el-form :model="closeInfo"
               label-width="190px">
        <el-form-item class="nr" label="操作备注：">
...
<style scoped>
  ...
  .content-section >>> .send-message-remark .el-form-item{
    margin-bottom: 10px;
  }
  .content-section >>> .send-message-remark .el-form-item__content{
    height: 30px;
    line-height: 30px;
  }
  .content-section >>> .send-message-remark .el-form-item__content .el-input__inner{
    width: 240px;
    height: 30px;
    line-height: 30px;
  }
  .content-section >>> .send-message-remark .inAddress .el-form-item__content{
    width: auto;
    height: 30px;
    line-height: 30px;
  }
  .content-section >>> .send-message-remark .inAddress .el-form-item__content select{
    height: 30px;
    line-height: 30px;
    padding: 3px;
    font-size: 14px;
  }
  .content-section >>> .send-message-remark .nr .el-form-item__content{
    height: auto;
    line-height: 30px;
  }
  .content-section >>> .send-message-remark .nr .el-form-item__content .el-textarea__inner{
    width: 400px;
    max-width: 500px;
    height: 70px;
    max-height: 70px;
  }
  .content-section >>> .el-dialog .el-dialog__footer button{
    line-height: 30px;
  }
</style>
