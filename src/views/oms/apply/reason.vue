<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <span>退货原因列表</span>
      <el-button size="primary" @click="handleAdd" class="btn-add initbtn">添加</el-button>
    </el-card>
    ...
    <el-dialog class="flex-reason" title="添加退货原因" :visible.sync="dialogVisible" width="30%">
      <el-form :model="returnReason" ref="reasonForm" label-width="85px">
...
<style scoped>
  .app-container >>> .flex-reason .el-form-item {
    display: flex;
    justify-content: center;
  }
  .app-container >>> .flex-reason .el-form-item .el-form-item__content{
    margin-left: 0 !important;
  }
  .app-container >>> .el-form-item {
    margin-bottom: 15px;
  }
  .app-container >>> .el-dialog__body .el-form-item__label{
    height: 30px;
  }
  .app-container >>> .el-dialog__body .el-input__inner {
    width: 240px;
    height: 30px;
  }
</style>
