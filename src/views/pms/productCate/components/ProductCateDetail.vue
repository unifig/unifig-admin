<template>
  <div class="content-section" style="margin-top: 70px;border-bottom: 0;">
    <div class="title">
      <span class="icon"></span>商品 - 添加商品分类
    </div>
    <el-card class="form-container" shadow="never" style="padding-top: 50px;margin-top: 0;border-bottom: 0;border-top: 0;border-radius: 0;">
...
<style scoped>
.form-container >>> .el-form-item .el-upload--picture .el-button--primary{
  padding: 6px 7px;
}
