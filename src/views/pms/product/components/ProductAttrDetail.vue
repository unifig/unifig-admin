<template>
  <div class="product-atr-detail" style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="商品规格：">
        <el-card shadow="never" class="cardBg">
          <div v-for="(productAttr,idx) in selectProductAttr" :key="idx">
            ...
            <div v-else>
              ...
              <el-input v-model="addProductAttrValue" style="width: 140px;margin-left: 10px" clearable></el-input>
        ...
        <el-table style="width: 100%;margin-top: 20px" :data="value.skuStockList" border>
          ...
          <el-table-column label="积分价" width="160" align="center">
            ...
            <el-table-column label="金额"  width="80" align="center">
              <template slot-scope="scope">
                <el-input v-model="scope.row.integralPrice"></el-input>
              </template>
            </el-table-column>
            <!--<template slot-scope="scope">
              <el-input v-model="scope.row.integral"></el-input>
          ...
          <el-table-column label="团购价格" align="center">
            <template slot-scope="scope">
              <el-input v-model.number="scope.row.groupPurchasePrice" type="number" step="0.0000000001" min='0' oninput = "value=value.replace(/[^\d.]/g,'')"></el-input>
            </template>
          </el-table-column>
      ...
      <el-form-item label="规格图片：" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item style="text-align: center">
        ...
        <el-button type="primary" size="medium" @click="handleNext">完成，提交商品</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleProductAttrChange(value) {
        this.getProductAttrList(0, value); // 获取商品规格
        this.getProductAttrList(1, value); // 获取商品参数
      },
...
<style scoped>
  ...
  .product-atr-detail .el-input--small .el-input__inner{
    width: 140px;
    height: 30px;
    line-height: 30px;
  }
