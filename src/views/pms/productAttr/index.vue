<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <span style="margin-top: 5px">商品类型列表</span>
      <el-button type="primary" class="btn-add initbtn" @click="addProductAttrCate()" size="mini">添加</el-button>
    </el-card>
    ...
    <el-dialog class="flex-product" :title="dialogTitle" :visible.sync="dialogVisible" width="30%">
      <el-form ref="productAttrCatForm" :model="productAttrCate" :rules="rules" label-width="95x">
...
<style scoped>
  .app-container >>> .flex-product .el-form-item{
    display: flex;
    justify-content:center;
  }
  .app-container >>> .flex-product .el-form-item .el-form-item__content{
    margin-left: 0 !important;
  }
 .app-container >>> .flex-product .el-form-item .el-form-item__content .el-input__inner{
   height: 30px;
   line-height: 30px;
 }
</style>
